import{s,b as p,j as t,t as a,i as I,k as j,G as Y,a as f,L as ee,H as b,J as te,r as u,I as m,K as ne,l as v,Q as ae,R as oe,U as X,V as k,W as M,X as ie,Y as se,Z as re,_ as le,$ as de,a0 as ce,a1 as H,c as pe,a2 as xe}from"./index-e449b0a6.js";import{u as $}from"./formik.esm-ac94993f.js";import{B as he}from"./BackgroundWrapper-c46803dd.js";const c={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},O=({currentPage:e,type:r,num:i})=>{switch(r){case"text":if(e===i)return"current";if(e>i)return"select";if(e<i)return"ordinary";break;case"bar":if(e===i)return"current";if(e>i)return"select";if(e<i)return"opacity-ordinary";break}},D={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},J=e=>{switch(e.variant){case"current":return D.current;case"select":return D.select;case"ordinary":return D.ordinary;case"opacity-ordinary":return D.opacityOrdinary;default:return"tomato"}},me=s.ul`
  max-width: 392px;
  display: flex;
...
`;function ke({formik:e,handleDefinePage:r,setFile:i,file:o}){const n=v(),{moreInfo:l}=b();u.useEffect(()=>{l.data.sex!==""&&e.setFieldValue("gender",l.data.sex)},[e.setFieldValue,l.data.sex]),u.useEffect(()=>{for(let x in l.data)l.data[x]!==""&&e.setFieldValue(x,l.data[x])},[e.setFieldValue,l.data]);const d=x=>{e.handleChange(x),n(X(x.target.id))},h=x=>{e.handleChange(x);const{name:_,value:y}=x.target;n(k({name:_,value:y}))};return t.jsxs(Ge,{onSubmit:e.handleSubmit,children:[t.jsxs(He,{children:[t.jsxs(Ue,{children:[t.jsx(Xe,{children:a("addPet_form_moreInfo_theSex")}),t.jsx(Ye,{children:t.jsxs(Re,{children:[t.jsx(L,{formik:e,text:a("other_female"),id:"female",onChange:d,value:c.female,checked:e.values.gender,icon:t.jsx(m,{iconName:"icon-female",stroke:e.values.gender===c.female?"#fff":e.values.gender===c.male?"#888888":"#F43F5E"})}),t.jsx(L,{formik:e,text:a("other_male"),id:"male",onChange:d,value:c.male,checked:e.values.gender,icon:t.jsx(m,{iconName:"icon-male",stroke:e.values.gender===c.male?"#fff":e.values.gender===c.female?"#888888":"#54ADFF"})})]})}),t.jsx(G,{text:a("addPet_form_moreInfo_file"),setFile:i,file:o,formik:e})]}),t.jsxs(We,{children:[t.jsx(g,{formik:e,text:a("other_location"),id:"location",name:"location",placeholder:a("addPet_form_moreInfo_location_placeholder"),value:e.values.location,onChange:h}),t.jsx(q,{formik:e})]})]}),t.jsxs(w,{children:[t.jsxs(C,{type:"submit",children:[a("other_done"),t.jsx(m,{iconName:"icon-pawprint",fill:"#FFFFFF"})]}),t.jsxs(P,{type:"button",onClick:()=>r(-1),children:[t.jsx(m,{iconName:"icon-arrow-left",stroke:"#54adff"}),a("other_back")]})]})]})}const Je=s.form`
  height: calc(100% - 120px);
  display: flex;
  flex-direction: column;
  gap: 24px;
